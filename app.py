...
if flair and t1 and t1ce and t2:
    ...
    st.markdown("###  Original vs Predicted Mask")
    c1, c2 = st.columns(2)
    with c1:
    ...
    # --- Footer ---
    st.markdown("<div class='footer'>Developed by <b>Louis Obadiah</b> | Brain Tumor Segmentation Project 🧠</div>", unsafe_allow_html=True)
